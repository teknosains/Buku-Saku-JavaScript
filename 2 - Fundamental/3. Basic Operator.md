...
const nama = null ?? 'Agus';
console.log(nama); // Agus

const umur = null;
const umurSaatIni = umur ?? 'Tidak ada umur';
console.log(umurSaatIni); // Tidak ada umur

let menikah; // bernilai undefined
let isMenikah = menikah ?? 'Belum menikah';
console.log(isMenikah); // Belum menikah

let menikah = 'Sudah menikah';
let isMenikah = menikah ?? 'Belum menikah';
console.log(isMenikah); // Sudah menikah
